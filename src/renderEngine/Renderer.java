...
public class Renderer {
	...
	public float[] backgroundColor = { 1,1,1,1 };
	...
	public void prepare() { // Called Every Frame
	...
	public  void render(EntityTextured3D entity, StaticShader shader) {
		...
		GL11.glBindTexture(GL13.GL_TEXTURE0, model.getTexture().getID());
		GL11.glDrawElements(GL11.GL_TRIANGLES, rawModel.getVertexCount(), GL11.GL_UNSIGNED_INT, 0); // Uses The G.P.U.
